        ...
        <Container maxWidth="lg" disableGutters>
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 2 }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              />
              <Box>
                <Typography variant="h6" fontWeight={700} sx={{ color: '#fff', lineHeight: 1.2, mb: 0.3 }}>
                  Estima tu colegiatura
                </Typography>
                <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.7)', maxWidth: 420 }}>
                  Selecciona tu categoría, grado y créditos para obtener un desglose estimado de tus costos cuatrimestrales.
                </Typography>
              </Box>
            </Box>
            ...
            <Box sx={{ display: 'flex', gap: 0.5, flexShrink: 0 }}>
              <Tooltip title={darkMode ? 'Modo claro' : 'Modo oscuro'} placement="bottom">
                ...
                >
                  <i className={darkMode ? 'fa-solid fa-sun' : 'fa-solid fa-moon'} style={{ fontSize: 17, width: 17, textAlign: 'center' }} />
                </IconButton>
              </Tooltip>
